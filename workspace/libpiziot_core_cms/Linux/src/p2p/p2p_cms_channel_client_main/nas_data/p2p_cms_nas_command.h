#ifndef __P2P_CMS_NAS_COMMAND_H__
#define __P2P_CMS_NAS_COMMAND_H__
...
extern "C"
{
    ...
    extern libpiziot_os_type_func_result_e p2p_cms_nas_command_send_to_channel_server(p2p_cms_nas_main_thread_info_t *Alpthread_info, unsigned char *Alpdata_send, int32_t Adata_size);

    extern void p2p_cms_nas_command_data_in_callback(void *Alpobject, int32_t Aviewer_handle, int32_t Achannel_client_handle, int32_t Achannel_id, struct sockaddr_in *Alpin_channel_server_ip, unsigned char *Alpdata, int32_t Adata_size);

    extern libpiziot_os_pthread_dword_t p2p_cms_nas_command_thread_instance_routine(void *arg);
...
#endif //__P2P_CMS_NAS_COMMAND_H__
