#ifndef __P2P_CMS_NAS_COMMAND_SECURITY_SYSTEM_H__
#define __P2P_CMS_NAS_COMMAND_SECURITY_SYSTEM_H__
...
extern "C"
{
    ...
    extern libpiziot_os_type_func_result_e p2p_cms_nas_command_security_system_parser(p2p_protocol_nas_command_e Acmd, int32_t Aarray_index, libpiziot_core_p2p_cmd_head_from_server_t *Alpcmd);

    extern void p2p_cms_nas_command_security_system_send_action(int32_t Aarray_index);

    extern void p2p_cms_nas_command_security_system_init_action(p2p_cms_nas_main_protocol_command_t *Alpprotocol_command);
...
#endif //__P2P_CMS_NAS_COMMAND_SECURITY_SYSTEM_H__
