...
#if defined(LIBPIZIOT_CORE_P2P_PROTOCOL_IPCAMERA_COMMAND)
#if defined(LIBPIZIOT_CORE_P2P_PROTOCOL_IPCAMERA_COMMAND_COMMON)
    p2p_cms_ipcamera_main_common_action_general_t action_common_model;
    p2p_cms_ipcamera_main_common_action_general_t action_common_fwverp2p;
    p2p_cms_ipcamera_main_common_action_general_t action_common_reboot;
    p2p_cms_ipcamera_main_common_action_timezone_t action_common_timezone;
#endif //defined(LIBPIZIOT_CORE_P2P_PROTOCOL_IPCAMERA_COMMAND_COMMON)
#endif //defined(LIBPIZIOT_CORE_P2P_PROTOCOL_IPCAMERA_COMMAND)
