...
static void p2p_cms_ipcamera_command_common_set_action(p2p_func_client_protocol_action_status_t* Alpprotocol_action_status) {
...
static void p2p_cms_ipcamera_command_common_clear_action(p2p_func_client_protocol_action_status_t* Alpprotocol_action_status) {
    Alpprotocol_action_status->protocol_action_flag = P2P_FUNC_CLIENT_PROTOCOL_ACTION_END;
}

static libpiziot_os_type_func_result_e p2p_cms_ipcamera_command_common_recv_get_model_resp(int32_t Aarray_index, libpiziot_core_p2p_cmd_head_from_server_t *Alpcmd, p2p_cms_ipcamera_main_common_action_general_t* Alpcommon_action_general, char *Alpstractoin) {
    ...
    if (Aarray_index) { LIBPIZIOT_FIX_ANDROID_COMPILE_MIPS_ERROR(0); }
    {
        ...
        if (size != sizeof(p2p_protocol_ipcamera_command_common_get_model_resp_t)) return rval;
        {
            ...
            p2p_cms_ipcamera_command_common_clear_action(&(Alpcommon_action_general->action_get));
        }
    }
...
static libpiziot_os_type_func_result_e p2p_cms_ipcamera_command_common_recv_get_fwverp2p_resp(int32_t Aarray_index, libpiziot_core_p2p_cmd_head_from_server_t *Alpcmd, p2p_cms_ipcamera_main_common_action_general_t *Alpcommon_action_general, char *Alpstractoin) {
    libpiziot_os_type_func_result_e rval = LIBPIZIOT_OS_TYPE_FUNC_RESULT_FAILURE;
    if (Aarray_index) { LIBPIZIOT_FIX_ANDROID_COMPILE_MIPS_ERROR(0); }
    {
...
static libpiziot_os_type_func_result_e p2p_cms_ipcamera_command_common_recv_set_reboot_resp(int32_t Aarray_index, libpiziot_core_p2p_cmd_head_from_server_t *Alpcmd, p2p_cms_ipcamera_main_common_action_general_t *Alpcommon_action_general, char *Alpstractoin) {
    libpiziot_os_type_func_result_e rval = LIBPIZIOT_OS_TYPE_FUNC_RESULT_FAILURE;
    if (Aarray_index) { LIBPIZIOT_FIX_ANDROID_COMPILE_MIPS_ERROR(0); }
    {
        ...
        if (size != sizeof(p2p_protocol_ipcamera_command_common_set_reboot_resp_t)) return rval;
        {
            ...
            p2p_cms_ipcamera_command_common_clear_action(&(Alpcommon_action_general->action_set));
        }
    }
    return LIBPIZIOT_OS_TYPE_FUNC_RESULT_SUCCESS;
}
...
static libpiziot_os_type_func_result_e p2p_cms_ipcamera_command_common_recv_set_timezone_resp(int32_t Aarray_index, libpiziot_core_p2p_cmd_head_from_server_t *Alpcmd, p2p_cms_ipcamera_main_common_action_timezone_t* Alpcommon_action_timezone, char *Alpstractoin) {
    libpiziot_os_type_func_result_e rval = LIBPIZIOT_OS_TYPE_FUNC_RESULT_FAILURE;
    if (Aarray_index) { LIBPIZIOT_FIX_ANDROID_COMPILE_MIPS_ERROR(0); }
    {
        ...
        if (size != sizeof(p2p_protocol_ipcamera_command_common_set_timezone_resp_t)) return rval;
        {
            ...
            p2p_cms_ipcamera_command_common_show_timezone_resp(lpdata_respond->cmd_info.channel_server_handle, Alpcommon_action_timezone->option_timezone_current, Alpstractoin, "SET");
            p2p_cms_ipcamera_command_common_clear_action(&(Alpcommon_action_timezone->action_set));
        }
    }
    return LIBPIZIOT_OS_TYPE_FUNC_RESULT_SUCCESS;
}
...
static libpiziot_os_type_func_result_e p2p_cms_ipcamera_command_common_recv_get_timezone_resp(int32_t Aarray_index, libpiziot_core_p2p_cmd_head_from_server_t *Alpcmd, p2p_cms_ipcamera_main_common_action_timezone_t *Alpcommon_action_timezone, char *Alpstractoin) {
    libpiziot_os_type_func_result_e rval = LIBPIZIOT_OS_TYPE_FUNC_RESULT_FAILURE;
    if (Aarray_index) { LIBPIZIOT_FIX_ANDROID_COMPILE_MIPS_ERROR(0); }
    {
        ...
        {
            Alpcommon_action_timezone->option_timezone_current = mem_endian_32((uint32_t)(lpdata_respond->option_timezone));
            p2p_cms_ipcamera_command_common_show_timezone_resp(lpdata_respond->cmd_info.channel_server_handle, Alpcommon_action_timezone->option_timezone_current, Alpstractoin, "GET");
            p2p_cms_ipcamera_command_common_clear_action(&(Alpcommon_action_timezone->action_get));
        }
    }
    return LIBPIZIOT_OS_TYPE_FUNC_RESULT_SUCCESS;
}
...
libpiziot_os_type_func_result_e p2p_cms_ipcamera_command_common_parser(p2p_protocol_ipcamera_command_e Acmd, int32_t Aarray_index, libpiziot_core_p2p_cmd_head_from_server_t *Alpcmd) {
    ...
    do {
        ...
        case P2P_PROTOCOL_IPCAMERA_COMMAND_COMMON_GET_MODEL_RESP: {
            p2p_cms_ipcamera_command_common_recv_get_model_resp(Aarray_index, Alpcmd, &(lpprotocol_command->action_common_model), "MODEL");
        }
                                                                  break;
        case P2P_PROTOCOL_IPCAMERA_COMMAND_COMMON_GET_FWVERP2P_RESP: {
            p2p_cms_ipcamera_command_common_recv_get_fwverp2p_resp(Aarray_index, Alpcmd, &(lpprotocol_command->action_common_fwverp2p), "FWVERP2P");
        }
                                                                     break;
        case P2P_PROTOCOL_IPCAMERA_COMMAND_COMMON_SET_REBOOT_RESP: {
            p2p_cms_ipcamera_command_common_recv_set_reboot_resp(Aarray_index, Alpcmd, &(lpprotocol_command->action_common_reboot), "REBOOT");
        }
                                                                   break;
        case P2P_PROTOCOL_IPCAMERA_COMMAND_COMMON_SET_TIMEZONE_RESP: {
            p2p_cms_ipcamera_command_common_recv_set_timezone_resp(Aarray_index, Alpcmd, &(lpprotocol_command->action_common_timezone), "TIMEZONE");
        }
                                                                     break;
        case P2P_PROTOCOL_IPCAMERA_COMMAND_COMMON_GET_TIMEZONE_RESP: {
            p2p_cms_ipcamera_command_common_recv_get_timezone_resp(Aarray_index, Alpcmd, &(lpprotocol_command->action_common_timezone), "TIMEZONE");
        }
                                                                     break;
        default: {
...
static libpiziot_os_type_func_result_e p2p_cms_ipcamera_command_common_check_time_to_resend_action(p2p_func_client_protocol_action_status_t* Alpprotocol_action_status) {
    libpiziot_os_type_func_result_e rval = LIBPIZIOT_OS_TYPE_FUNC_RESULT_FAILURE;
    libpiziot_os_mutex_plock_lock(&p2p_cms_main_ipcamera_channel_mutex);
    do {
...
void p2p_cms_ipcamera_command_common_send_action(int32_t Aarray_index) {
    ...
    if (rval == LIBPIZIOT_OS_TYPE_FUNC_RESULT_SUCCESS) {
        if (p2p_cms_ipcamera_command_common_check_time_to_resend_action(&(lpprotocol_command->action_common_model.action_get)) == LIBPIZIOT_OS_TYPE_FUNC_RESULT_SUCCESS) {
            p2p_cms_ipcamera_command_common_send_get_model_req(Aarray_index, P2P_PROTOCOL_IPCAMERA_COMMAND_COMMON_GET_MODEL_REQ);
        }
        if (p2p_cms_ipcamera_command_common_check_time_to_resend_action(&(lpprotocol_command->action_common_fwverp2p.action_get)) == LIBPIZIOT_OS_TYPE_FUNC_RESULT_SUCCESS) {
            p2p_cms_ipcamera_command_common_send_get_fwverp2p_req(Aarray_index, P2P_PROTOCOL_IPCAMERA_COMMAND_COMMON_GET_FWVERP2P_REQ);
        }
        if (p2p_cms_ipcamera_command_common_check_time_to_resend_action(&(lpprotocol_command->action_common_reboot.action_set)) == LIBPIZIOT_OS_TYPE_FUNC_RESULT_SUCCESS) {
            p2p_cms_ipcamera_command_common_send_set_reboot_req(Aarray_index, P2P_PROTOCOL_IPCAMERA_COMMAND_COMMON_SET_REBOOT_REQ);
        }
        if (p2p_cms_ipcamera_command_common_check_time_to_resend_action(&(lpprotocol_command->action_common_timezone.action_set)) == LIBPIZIOT_OS_TYPE_FUNC_RESULT_SUCCESS) {
            p2p_cms_ipcamera_command_common_send_set_timezone_req(Aarray_index, P2P_PROTOCOL_IPCAMERA_COMMAND_COMMON_SET_TIMEZONE_REQ, lpprotocol_command->action_common_timezone.option_timezone_set);
        }
        if (p2p_cms_ipcamera_command_common_check_time_to_resend_action(&(lpprotocol_command->action_common_timezone.action_get)) == LIBPIZIOT_OS_TYPE_FUNC_RESULT_SUCCESS) {
            p2p_cms_ipcamera_command_common_send_get_timezone_req(Aarray_index, P2P_PROTOCOL_IPCAMERA_COMMAND_COMMON_GET_TIMEZONE_REQ);
        }
    }
}

void p2p_cms_ipcamera_command_common_init_action(p2p_cms_ipcamera_main_protocol_command_t *Alpprotocol_command) {
...
libpiziot_os_type_func_result_e libpiziot_core_p2p_cms_ipcamera_channel_common_get_model(int32_t Aarray_index) {
    ...
    do {
        ...
        p2p_cms_ipcamera_command_common_set_action(&(lpprotocol_command->action_common_model.action_get));
        rval = LIBPIZIOT_OS_TYPE_FUNC_RESULT_SUCCESS;
    } while (0);
    libpiziot_os_mutex_plock_unlock(&p2p_cms_main_ipcamera_channel_mutex);
    return rval;
...
libpiziot_os_type_func_result_e libpiziot_core_p2p_cms_ipcamera_channel_common_get_fwverp2p(int32_t Aarray_index) {
    ...
    do {
        ...
        p2p_cms_ipcamera_command_common_set_action(&(lpprotocol_command->action_common_fwverp2p.action_get));
        rval = LIBPIZIOT_OS_TYPE_FUNC_RESULT_SUCCESS;
    } while (0);
    libpiziot_os_mutex_plock_unlock(&p2p_cms_main_ipcamera_channel_mutex);
    return rval;
...
libpiziot_os_type_func_result_e libpiziot_core_p2p_cms_ipcamera_channel_common_set_reboot(int32_t Aarray_index) {
    ...
    do {
        ...
        p2p_cms_ipcamera_command_common_set_action(&(lpprotocol_command->action_common_reboot.action_set));
        rval = LIBPIZIOT_OS_TYPE_FUNC_RESULT_SUCCESS;
    } while (0);
    libpiziot_os_mutex_plock_unlock(&p2p_cms_main_ipcamera_channel_mutex);
    return rval;
...
libpiziot_os_type_func_result_e libpiziot_core_p2p_cms_ipcamera_channel_common_set_timezone(int32_t Aarray_index, libpiziot_core_p2p_protocol_optoin_timezone_e Aoption_timezone) {
    ...
    do {
        ...
        p2p_cms_ipcamera_command_common_set_action(&(lpprotocol_command->action_common_timezone.action_set));
...
libpiziot_os_type_func_result_e libpiziot_core_p2p_cms_ipcamera_channel_common_get_timezone(int32_t Aarray_index) {
    ...
    do {
        ...
        p2p_cms_ipcamera_command_common_set_action(&(lpprotocol_command->action_common_timezone.action_get));
        rval = LIBPIZIOT_OS_TYPE_FUNC_RESULT_SUCCESS;
    } while (0);
    libpiziot_os_mutex_plock_unlock(&p2p_cms_main_ipcamera_channel_mutex);
    return rval;
