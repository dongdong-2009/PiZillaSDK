...
#include "../piziot_core_ipcamera/piziot_core_ipcamera.h"
...
libpiziot_core_ipcamera_event_p lplibpiziot_core_ipcamera_event = 0;
#endif //defined(ENABLE_MFC_GUI)
#endif //defined(__LIBPIZIOT_OS_PLATFORM_MFC__)

#if defined(ENABLE_P2P_IPCAMERA) || defined(ENABLE_P2P_NAS) || defined(ENABLE_P2P_HTSERVER)
#define ENABLE_SHOW_FREE_SD_SPACE
#endif //defined(ENABLE_P2P_IPCAMERA) || defined(ENABLE_P2P_NAS) || defined(ENABLE_P2P_HTSERVER)
...
void misc_setting_iptables_enable(void) {
    ...
    do
    {
        ...
        TRACEA("PIZCam:Wait iptables bring up ...\n");
        usleep(1000000);
    } while (1);
