...
//Define this Header
#include "p2p_ipcamera_device_command_common.h"
...
static libpiziot_os_type_func_result_e p2p_ipcamera_device_command_common_recv_get_fwverp2p_req(libpiziot_core_p2p_cmd_head_from_client_t *Alpcmd, char *Alpstractoin) {
    libpiziot_os_type_func_result_e rval = LIBPIZIOT_OS_TYPE_FUNC_RESULT_FAILURE;
    {
...
static libpiziot_os_type_func_result_e p2p_ipcamera_device_command_common_recv_set_reboot_req(libpiziot_core_p2p_cmd_head_from_client_t *Alpcmd, char *Alpstractoin) {
    libpiziot_os_type_func_result_e rval = LIBPIZIOT_OS_TYPE_FUNC_RESULT_FAILURE;
    {
...
libpiziot_os_type_func_result_e p2p_ipcamera_device_command_common_parser(p2p_protocol_ipcamera_command_e Acmd, int32_t Aarray_index, libpiziot_core_p2p_cmd_head_from_client_t *Alpcmd, libpiziot_core_p2p_data_from_client_head_t *Alphead) {
...
void p2p_ipcamera_device_command_common_send_action(int32_t Aarray_index) {
    libpiziot_os_type_func_result_e rval = LIBPIZIOT_OS_TYPE_FUNC_RESULT_FAILURE;
    p2p_ipcamera_device_main_protocol_command_t *lpprotocol_command = 0;
    libpiziot_os_mutex_plock_lock(&p2p_ipcamera_main_device_channel_mutex);
    {
