...
static void p2p_ipcamera_main_device_channel_update_mode(p2p_ipcamera_main_device_thread_info_t *Alpthread_info, int32_t Adevice_handle, int32_t Achannel_id, libpiziot_os_pthread_routine_p Alppthread_routine, libpiziot_p2p_common_channel_data_in_p Alpdata_in_callback, int32_t Asend_data_max_size, int32_t Asend_buffer_size, int32_t Arecv_data_max_size, p2p_func_client_channel_aes_e Aenable_channel_aes, p2p_ipcamera_device_main_protocol_command_t *Alpprotocol_command) {
    ...
    if (mode == P2P_FUNC_CLIENT_CHANNEL_ENABLE_YES) {
        p2p_ipcamera_device_main_start_thread(Alpthread_info, Adevice_handle, Alpthread_info->update_thread_info_index, Achannel_id, Alppthread_routine, Alpdata_in_callback, Asend_data_max_size, Asend_buffer_size, Arecv_data_max_size, Aenable_channel_aes);
        {
            libpiziot_os_mutex_plock_lock(&p2p_ipcamera_main_device_channel_mutex);
            {
    ...
    if (mode == P2P_FUNC_CLIENT_CHANNEL_ENABLE_NO) {
        ...
        libpiziot_os_mutex_plock_unlock(&p2p_ipcamera_main_device_channel_mutex);
        p2p_ipcamera_device_main_stop_thread(Alpthread_info, Alpthread_info->update_thread_info_index);
    }
...
static void p2p_ipcamera_main_device_start_channel_thread(p2p_ipcamera_main_device_thread_info_t *Alpthread_info) {
    if (Alpthread_info) {
        ...
        p2p_ipcamera_main_device_channel_update_mode(Alpthread_info, Alpthread_info->p2p_ipcamera_main_device_handle, LIBPIZIOT_CORE_P2P_PROTOCOL_IPCAMERA_COMMAND, p2p_ipcamera_device_command_thread_instance_routine, p2p_ipcamera_device_command_data_in_callback, p2p_protocol_ipcamera_command_device_send_data_max_size, p2p_protocol_ipcamera_command_device_send_data_max_size, p2p_protocol_ipcamera_command_device_recv_data_max_size, P2P_FUNC_CLIENT_CHANNEL_AES_ENABLE, &(Alpthread_info->protocol_command));
        ...
        p2p_ipcamera_main_device_channel_update_mode(Alpthread_info, Alpthread_info->p2p_ipcamera_main_device_handle, LIBPIZIOT_CORE_P2P_PROTOCOL_IPCAMERA_OTHER, p2p_ipcamera_device_other_thread_instance_routine, p2p_ipcamera_device_other_data_in_callback, P2P_PROTOCOL_IPCAMERA_OTHER_DEVICE_SEND_DATA_MAX_SIZE, P2P_PROTOCOL_IPCAMERA_OTHER_DEVICE_SEND_DATA_MAX_SIZE * 2, P2P_PROTOCOL_IPCAMERA_OTHER_DEVICE_RECV_DATA_MAX_SIZE, P2P_FUNC_CLIENT_CHANNEL_AES_ENABLE, &(Alpthread_info->protocol_other));
...
static void p2p_ipcamera_main_device_stop_channel_thread(p2p_ipcamera_main_device_thread_info_t *Alpthread_info) {
    p2p_ipcamera_device_main_stop_thread_all(Alpthread_info);
}
...
libpiziot_os_type_func_result_e p2p_ipcamera_main_device_finalize(p2p_ipcamera_main_device_thread_info_t **Alpp_thread_info) {
    ...
    do {
        ...
        if (lpthread_info->instance_mutex.init != LIBPIZIOT_OS_MUTEX_STUCT_INIT_CHECK_VALUE) break;
        {
            ...
            p2p_ipcamera_device_main_finalize(lpthread_info);
        }
        {
    ...
    do {
        ...
        (*Alpp_thread_info) = lpthread_info;
        {
            ...
            lpthread_info->thread_instance.m_extra = lpthread_info;
            {
                ...
                {
                    if (p2p_ipcamera_device_main_initialize(lpthread_info) != LIBPIZIOT_OS_TYPE_FUNC_RESULT_SUCCESS) {
                        break;
                    }
                }
            }
