...
#define P2P_PROTOCOL_IPCAMERA_OTHER_VIEWER_SEND_DATA_MAX_SIZE 0 //(512 * 1024) //LIBPIZIOT_P2P_COMMON_SEND_DATA_MAX_SIZE
...
#define P2P_PROTOCOL_IPCAMERA_MAX_SEND_BYTES_PER_SECOND (512 * 1024)
