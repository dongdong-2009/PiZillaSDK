...
//Define this Header
#include "p2p_nas_ipcamera_command_common.h"
...
static libpiziot_os_type_func_result_e p2p_nas_ipcamera_command_common_send_get_model_req(int32_t Aarray_index, p2p_protocol_ipcamera_command_e Acmd) {
    libpiziot_os_type_func_result_e rval = LIBPIZIOT_OS_TYPE_FUNC_RESULT_FAILURE;
...
static libpiziot_os_type_func_result_e p2p_nas_ipcamera_command_common_send_get_fwverp2p_req(int32_t Aarray_index, p2p_protocol_ipcamera_command_e Acmd) {
    libpiziot_os_type_func_result_e rval = LIBPIZIOT_OS_TYPE_FUNC_RESULT_FAILURE;
...
static libpiziot_os_type_func_result_e p2p_nas_ipcamera_command_common_send_set_reboot_req(int32_t Aarray_index, p2p_protocol_ipcamera_command_e Acmd) {
    libpiziot_os_type_func_result_e rval = LIBPIZIOT_OS_TYPE_FUNC_RESULT_FAILURE;
...
static void p2p_nas_ipcamera_command_common_show_timezone_resp(uint32_t Achannel_server_handle, libpiziot_core_p2p_protocol_optoin_timezone_e Atimezone, char *Alpstractoin, char *AlpstrSG) {
...
static libpiziot_os_type_func_result_e p2p_nas_ipcamera_command_common_send_set_timezone_req(int32_t Aarray_index, p2p_protocol_ipcamera_command_e Acmd, libpiziot_core_p2p_protocol_optoin_timezone_e Aoption_timezone) {
    libpiziot_os_type_func_result_e rval = LIBPIZIOT_OS_TYPE_FUNC_RESULT_FAILURE;
...
static libpiziot_os_type_func_result_e p2p_nas_ipcamera_command_common_send_get_timezone_req(int32_t Aarray_index, p2p_protocol_ipcamera_command_e Acmd) {
    libpiziot_os_type_func_result_e rval = LIBPIZIOT_OS_TYPE_FUNC_RESULT_FAILURE;
...
libpiziot_os_type_func_result_e p2p_nas_ipcamera_command_common_parser(p2p_protocol_ipcamera_command_e Acmd, int32_t Aarray_index, libpiziot_core_p2p_cmd_head_from_server_t *Alpcmd) {
...
void p2p_nas_ipcamera_command_common_send_action(int32_t Aarray_index) {
    libpiziot_os_type_func_result_e rval = LIBPIZIOT_OS_TYPE_FUNC_RESULT_FAILURE;
    p2p_nas_ipcamera_main_protocol_command_t *lpprotocol_command = 0;
    libpiziot_os_mutex_plock_lock(&p2p_nas_main_viewer_channel_mutex);
    {
