...
#define P2P_PROTOCOL_NAS_OTHER_VIEWER_SEND_DATA_MAX_SIZE (512 * 1024) //LIBPIZIOT_P2P_COMMON_SEND_DATA_MAX_SIZE
...
#define P2P_PROTOCOL_NAS_MAX_SEND_BYTES_PER_SECOND (4 * 1024 * 1024 / 8)
