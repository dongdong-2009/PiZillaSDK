#ifndef __P2P_NAS_DEVICE_CHANNEL_MAIN_H__
#define __P2P_NAS_DEVICE_CHANNEL_MAIN_H__
...
typedef struct p2p_nas_device_channel_main_thread_info_s p2p_nas_device_channel_main_thread_info_t;

#if defined(LIBPIZIOT_CORE_P2P_PROTOCOL_NAS_COMMAND)
#if defined(LIBPIZIOT_CORE_P2P_PROTOCOL_NAS_COMMAND_COMMON)
typedef struct p2p_nas_device_channel_main_common_action_general_s {
    p2p_func_client_protocol_action_status_t action_set;
    p2p_func_client_protocol_action_status_t action_get;
} p2p_nas_device_channel_main_common_action_general_t;

typedef struct p2p_nas_device_channel_main_common_action_timezone_s {
    p2p_func_client_protocol_action_status_t action_set;
    p2p_func_client_protocol_action_status_t action_get;
    libpiziot_core_p2p_protocol_optoin_timezone_e option_timezone_current;
} p2p_nas_device_channel_main_common_action_timezone_t;
...
typedef struct p2p_nas_device_channel_main_zigbee_action_general_s {
    p2p_func_client_protocol_action_status_t action_set;
    p2p_func_client_protocol_action_status_t action_get;
    libpiziot_core_p2p_protocol_optoin_yn_e option_yn_current;
} p2p_nas_device_channel_main_zigbee_action_general_t;
...
typedef struct p2p_nas_device_channel_main_protocol_command_s {
#if defined(LIBPIZIOT_CORE_P2P_PROTOCOL_NAS_COMMAND)
#if defined(LIBPIZIOT_CORE_P2P_PROTOCOL_NAS_COMMAND_COMMON)
    p2p_nas_device_channel_main_common_action_general_t action_common_model;
    p2p_nas_device_channel_main_common_action_general_t action_common_fwverp2p;
    p2p_nas_device_channel_main_common_action_general_t action_common_reboot;
    p2p_nas_device_channel_main_common_action_timezone_t action_common_timezone;
#endif //defined(LIBPIZIOT_CORE_P2P_PROTOCOL_NAS_COMMAND_COMMON)
#if defined(LIBPIZIOT_CORE_P2P_PROTOCOL_NAS_COMMAND_SECURITY_SYSTEM)
    p2p_nas_device_channel_main_zigbee_action_general_t action_zigbee_lock;
    p2p_nas_device_channel_main_zigbee_action_general_t action_zigbee_mute;
    p2p_nas_device_channel_main_zigbee_action_general_t action_zigbee_callout;
#endif //defined(LIBPIZIOT_CORE_P2P_PROTOCOL_NAS_COMMAND_SECURITY_SYSTEM)
#endif //defined(LIBPIZIOT_CORE_P2P_PROTOCOL_NAS_COMMAND)
    p2p_func_client_channel_enable_flag_t channel_enable_flag;
    p2p_nas_device_channel_main_thread_info_t *lpthread_info;
...
struct p2p_nas_device_channel_main_thread_info_s {
...
extern "C"
{
    ...
    extern void p2p_nas_device_channel_main_stop_thread_all(p2p_nas_main_device_thread_info_t *Alpp2p_nas_main_device_thread_info);

    extern libpiziot_os_type_func_result_e p2p_nas_device_channel_main_start_thread(p2p_nas_main_device_thread_info_t *Alpp2p_nas_main_device_thread_info, int32_t Adevice_handle, int32_t Athread_info_index, int32_t Achannel_id, libpiziot_os_pthread_routine_p Alppthread_routine, libpiziot_p2p_common_channel_data_in_p Alpdata_in_callback, int32_t Asend_data_max_size, int32_t Asend_buffer_size, int32_t Arecv_data_max_size, p2p_func_client_channel_aes_e Aenable_channel_aes);

    extern libpiziot_os_type_func_result_e p2p_nas_device_channel_main_stop_thread(p2p_nas_main_device_thread_info_t *Alpp2p_nas_main_device_thread_info, int32_t Athread_info_index);

    extern void p2p_nas_device_channel_main_finalize(p2p_nas_main_device_thread_info_t *Alpp2p_nas_main_device_thread_info);

    extern libpiziot_os_type_func_result_e p2p_nas_device_channel_main_initialize(p2p_nas_main_device_thread_info_t *Alpp2p_nas_main_device_thread_info);
...
#endif //__P2P_NAS_DEVICE_CHANNEL_MAIN_H__
