...
#if defined(LIBPIZIOT_CORE_P2P_PROTOCOL_NAS_COMMAND)
#if defined(LIBPIZIOT_CORE_P2P_PROTOCOL_NAS_COMMAND_COMMON)
    p2p_nas_device_main_common_action_general_t action_common_model;
    p2p_nas_device_main_common_action_general_t action_common_fwverp2p;
    p2p_nas_device_main_common_action_general_t action_common_reboot;
    p2p_nas_device_main_common_action_timezone_t action_common_timezone;
#endif //defined(LIBPIZIOT_CORE_P2P_PROTOCOL_NAS_COMMAND_COMMON)
#if defined(LIBPIZIOT_CORE_P2P_PROTOCOL_NAS_COMMAND_SECURITY_SYSTEM)
    p2p_nas_device_main_zigbee_action_general_t action_zigbee_lock;
    p2p_nas_device_main_zigbee_action_general_t action_zigbee_mute;
    p2p_nas_device_main_zigbee_action_general_t action_zigbee_callout;
#endif //defined(LIBPIZIOT_CORE_P2P_PROTOCOL_NAS_COMMAND_SECURITY_SYSTEM)
#endif //defined(LIBPIZIOT_CORE_P2P_PROTOCOL_NAS_COMMAND)
