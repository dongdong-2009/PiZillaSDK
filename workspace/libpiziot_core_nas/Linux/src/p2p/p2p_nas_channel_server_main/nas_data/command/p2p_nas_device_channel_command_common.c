...
//Define this Header
#include "p2p_nas_device_channel_command_common.h"
...
static void p2p_nas_device_channel_command_common_set_action(p2p_func_client_protocol_action_status_t* Alpprotocol_action_status) {
...
static libpiziot_os_type_func_result_e p2p_nas_device_channel_command_common_recv_get_model_req(libpiziot_core_p2p_cmd_head_from_client_t *Alpcmd, char *Alpstractoin) {
...
static libpiziot_os_type_func_result_e p2p_nas_device_channel_command_common_send_get_model_resp(p2p_nas_device_channel_main_protocol_command_t *Alpprotocol_command, p2p_nas_device_channel_main_common_action_general_t *Alpcommon_action_general, p2p_protocol_nas_command_e Acmd, libpiziot_core_p2p_data_from_client_head_t *Alphead) {
    libpiziot_os_type_func_result_e rval = LIBPIZIOT_OS_TYPE_FUNC_RESULT_FAILURE;
    {
...
#error
        ...
        p2p_nas_device_channel_command_common_set_action(&(Alpcommon_action_general->action_get));
    }
    return rval;
}

static libpiziot_os_type_func_result_e p2p_nas_device_channel_command_common_recv_get_fwverp2p_req(libpiziot_core_p2p_cmd_head_from_client_t *Alpcmd, char *Alpstractoin) {
    libpiziot_os_type_func_result_e rval = LIBPIZIOT_OS_TYPE_FUNC_RESULT_FAILURE;
    {
...
static libpiziot_os_type_func_result_e p2p_nas_device_channel_command_common_send_get_fwverp2p_resp(p2p_nas_device_channel_main_protocol_command_t *Alpprotocol_command, p2p_nas_device_channel_main_common_action_general_t *Alpcommon_action_general, p2p_protocol_nas_command_e Acmd, libpiziot_core_p2p_data_from_client_head_t *Alphead) {
    libpiziot_os_type_func_result_e rval = LIBPIZIOT_OS_TYPE_FUNC_RESULT_FAILURE;
    {
...
static libpiziot_os_type_func_result_e p2p_nas_device_channel_command_common_recv_set_reboot_req(libpiziot_core_p2p_cmd_head_from_client_t *Alpcmd, char *Alpstractoin) {
    libpiziot_os_type_func_result_e rval = LIBPIZIOT_OS_TYPE_FUNC_RESULT_FAILURE;
    {
...
static libpiziot_os_type_func_result_e p2p_nas_device_channel_command_common_send_set_reboot_resp(p2p_nas_device_channel_main_protocol_command_t *Alpprotocol_command, p2p_nas_device_channel_main_common_action_general_t *Alpcommon_action_general, p2p_protocol_nas_command_e Acmd, libpiziot_core_p2p_data_from_client_head_t *Alphead) {
    libpiziot_os_type_func_result_e rval = LIBPIZIOT_OS_TYPE_FUNC_RESULT_FAILURE;
    {
        ...
        rval = p2p_nas_device_channel_command_send_to_channel_client(Alpprotocol_command->lpthread_info, (unsigned char *) &(data_respond), sizeof(data_respond));
        p2p_nas_device_channel_command_common_set_action(&(Alpcommon_action_general->action_set));
    }
    return rval;
}

static libpiziot_os_type_func_result_e p2p_nas_device_channel_command_common_recv_set_timezone_req(p2p_nas_device_channel_main_common_action_timezone_t *Alpcommon_action_timezone, libpiziot_core_p2p_cmd_head_from_client_t *Alpcmd, char *Alpstractoin) {
    libpiziot_os_type_func_result_e rval = LIBPIZIOT_OS_TYPE_FUNC_RESULT_FAILURE;
    {
...
static libpiziot_os_type_func_result_e p2p_nas_device_channel_command_common_send_set_timezone_resp(p2p_nas_device_channel_main_protocol_command_t *Alpprotocol_command, p2p_nas_device_channel_main_common_action_timezone_t *Alpcommon_action_timezone, p2p_protocol_nas_command_e Acmd, libpiziot_core_p2p_data_from_client_head_t *Alphead) {
    libpiziot_os_type_func_result_e rval = LIBPIZIOT_OS_TYPE_FUNC_RESULT_FAILURE;
    {
        ...
        if (Alphead->channel_server_handle) { LIBPIZIOT_FIX_ANDROID_COMPILE_MIPS_ERROR(0); }
        rval = p2p_nas_device_channel_command_send_to_channel_client(Alpprotocol_command->lpthread_info, (unsigned char *) &(data_respond), sizeof(data_respond));
        p2p_nas_device_channel_command_common_set_action(&(Alpcommon_action_timezone->action_set));
    }
    return rval;
}

static libpiziot_os_type_func_result_e p2p_nas_device_channel_command_common_recv_get_timezone_req(p2p_nas_device_channel_main_common_action_timezone_t *Alpcommon_action_timezone, libpiziot_core_p2p_cmd_head_from_client_t *Alpcmd, char *Alpstractoin) {
    libpiziot_os_type_func_result_e rval = LIBPIZIOT_OS_TYPE_FUNC_RESULT_FAILURE;
    {
...
static libpiziot_os_type_func_result_e p2p_nas_device_channel_command_common_send_get_timezone_resp(p2p_nas_device_channel_main_protocol_command_t *Alpprotocol_command, p2p_nas_device_channel_main_common_action_timezone_t *Alpcommon_action_general, p2p_protocol_nas_command_e Acmd, libpiziot_core_p2p_data_from_client_head_t *Alphead) {
    libpiziot_os_type_func_result_e rval = LIBPIZIOT_OS_TYPE_FUNC_RESULT_FAILURE;
    {
...
libpiziot_os_type_func_result_e p2p_nas_device_channel_command_common_parser(p2p_protocol_nas_command_e Acmd, int32_t Aarray_index, libpiziot_core_p2p_cmd_head_from_client_t *Alpcmd, libpiziot_core_p2p_data_from_client_head_t *Alphead) {
    ...
    do {
        ...
        case P2P_PROTOCOL_NAS_COMMAND_COMMON_GET_MODEL_REQ: {
            p2p_nas_device_channel_command_common_recv_get_model_req(Alpcmd, "MODEL");
            p2p_nas_device_channel_command_common_send_get_model_resp(lpprotocol_command, &(lpprotocol_command->action_common_model), P2P_PROTOCOL_NAS_COMMAND_COMMON_GET_MODEL_RESP, Alphead);
        }
                                                            break;
        case P2P_PROTOCOL_NAS_COMMAND_COMMON_GET_FWVERP2P_REQ: {
            p2p_nas_device_channel_command_common_recv_get_fwverp2p_req(Alpcmd, "FWVERP2P");
            p2p_nas_device_channel_command_common_send_get_fwverp2p_resp(lpprotocol_command, &(lpprotocol_command->action_common_fwverp2p), P2P_PROTOCOL_NAS_COMMAND_COMMON_GET_FWVERP2P_RESP, Alphead);
        }
                                                               break;
        case P2P_PROTOCOL_NAS_COMMAND_COMMON_SET_REBOOT_REQ: {
            p2p_nas_device_channel_command_common_recv_set_reboot_req(Alpcmd, "REBOOT");
            p2p_nas_device_channel_command_common_send_set_reboot_resp(lpprotocol_command, &(lpprotocol_command->action_common_reboot), P2P_PROTOCOL_NAS_COMMAND_COMMON_SET_REBOOT_RESP, Alphead);
        }
                                                             break;
        case P2P_PROTOCOL_NAS_COMMAND_COMMON_SET_TIMEZONE_REQ: {
            p2p_nas_device_channel_command_common_recv_set_timezone_req(&(lpprotocol_command->action_common_timezone), Alpcmd, "TIMEZONE");
            p2p_nas_device_channel_command_common_send_set_timezone_resp(lpprotocol_command, &(lpprotocol_command->action_common_timezone), P2P_PROTOCOL_NAS_COMMAND_COMMON_SET_TIMEZONE_RESP, Alphead);
        }
                                                               break;
        case P2P_PROTOCOL_NAS_COMMAND_COMMON_GET_TIMEZONE_REQ: {
            p2p_nas_device_channel_command_common_recv_get_timezone_req(&(lpprotocol_command->action_common_timezone), Alpcmd, "TIMEZONE");
            p2p_nas_device_channel_command_common_send_get_timezone_resp(lpprotocol_command, &(lpprotocol_command->action_common_timezone), P2P_PROTOCOL_NAS_COMMAND_COMMON_GET_TIMEZONE_RESP, Alphead);
        }
                                                               break;
        default: {
...
void p2p_nas_device_channel_command_common_send_action(int32_t Aarray_index) {
    libpiziot_os_type_func_result_e rval = LIBPIZIOT_OS_TYPE_FUNC_RESULT_FAILURE;
...
void p2p_nas_device_channel_command_common_init_action(p2p_nas_device_channel_main_protocol_command_t *Alpprotocol_command) {
