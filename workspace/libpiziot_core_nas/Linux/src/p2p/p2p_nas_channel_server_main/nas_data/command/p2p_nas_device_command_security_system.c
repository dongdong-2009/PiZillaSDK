...
static void p2p_nas_device_command_security_system_set_action(p2p_func_client_protocol_action_status_t* Alpprotocol_action_status) {
...
static libpiziot_os_type_func_result_e p2p_nas_device_command_security_system_recv_set_yn_req(p2p_nas_device_main_zigbee_action_general_t *Alpzigbee_action_general, libpiziot_core_p2p_cmd_head_from_client_t *Alpcmd, char *Alpstractoin) {
...
static libpiziot_os_type_func_result_e p2p_nas_device_command_security_system_send_set_yn_resp(p2p_nas_device_main_protocol_command_t *Alpprotocol_command, p2p_nas_device_main_zigbee_action_general_t *Alpzigbee_action_general, p2p_protocol_nas_command_e Acmd, libpiziot_core_p2p_data_from_client_head_t *Alphead) {
    libpiziot_os_type_func_result_e rval = LIBPIZIOT_OS_TYPE_FUNC_RESULT_FAILURE;
    {
        ...
        p2p_nas_device_command_security_system_set_action(&(Alpzigbee_action_general->action_set));
    }
    return rval;
}

static libpiziot_os_type_func_result_e p2p_nas_device_command_security_system_recv_get_yn_req(p2p_nas_device_main_zigbee_action_general_t *Alpzigbee_action_general, libpiziot_core_p2p_cmd_head_from_client_t *Alpcmd, char *Alpstractoin) {
    libpiziot_os_type_func_result_e rval = LIBPIZIOT_OS_TYPE_FUNC_RESULT_FAILURE;
    {
...
static libpiziot_os_type_func_result_e p2p_nas_device_command_security_system_send_get_yn_resp(p2p_nas_device_main_protocol_command_t *Alpprotocol_command, p2p_nas_device_main_zigbee_action_general_t *Alpzigbee_action_general, p2p_protocol_nas_command_e Acmd, libpiziot_core_p2p_data_from_client_head_t *Alphead) {
    libpiziot_os_type_func_result_e rval = LIBPIZIOT_OS_TYPE_FUNC_RESULT_FAILURE;
    {
        ...
        rval = p2p_nas_device_command_send_to_channel_client(Alpprotocol_command->lpthread_info, (unsigned char *) &(data_respond), sizeof(data_respond));
        p2p_nas_device_command_security_system_set_action(&(Alpzigbee_action_general->action_get));
    }
    return rval;
}
...
libpiziot_os_type_func_result_e p2p_nas_device_command_security_system_parser(p2p_protocol_nas_command_e Acmd, int32_t Aarray_index, libpiziot_core_p2p_cmd_head_from_client_t *Alpcmd, libpiziot_core_p2p_data_from_client_head_t *Alphead) {
    ...
    do {
        ...
        case P2P_PROTOCOL_NAS_COMMAND_SECURITY_SYSTEM_SET_LOCK_REQ: {
            p2p_nas_device_command_security_system_recv_set_yn_req(&(lpprotocol_command->action_zigbee_lock), Alpcmd, "LOCK");
            p2p_nas_device_command_security_system_send_set_yn_resp(lpprotocol_command, &(lpprotocol_command->action_zigbee_lock), P2P_PROTOCOL_NAS_COMMAND_SECURITY_SYSTEM_SET_LOCK_RESP, Alphead);
        }
                                                                    break;
        case P2P_PROTOCOL_NAS_COMMAND_SECURITY_SYSTEM_GET_LOCK_REQ: {
            p2p_nas_device_command_security_system_recv_get_yn_req(&(lpprotocol_command->action_zigbee_lock), Alpcmd, "LOCK");
            p2p_nas_device_command_security_system_send_get_yn_resp(lpprotocol_command, &(lpprotocol_command->action_zigbee_lock), P2P_PROTOCOL_NAS_COMMAND_SECURITY_SYSTEM_GET_LOCK_RESP, Alphead);
        }
                                                                    break;
        case P2P_PROTOCOL_NAS_COMMAND_SECURITY_SYSTEM_SET_MUTE_REQ: {
            p2p_nas_device_command_security_system_recv_set_yn_req(&(lpprotocol_command->action_zigbee_mute), Alpcmd, "MUTE");
            p2p_nas_device_command_security_system_send_set_yn_resp(lpprotocol_command, &(lpprotocol_command->action_zigbee_mute), P2P_PROTOCOL_NAS_COMMAND_SECURITY_SYSTEM_SET_MUTE_RESP, Alphead);
        }
                                                                    break;
        case P2P_PROTOCOL_NAS_COMMAND_SECURITY_SYSTEM_GET_MUTE_REQ: {
            p2p_nas_device_command_security_system_recv_get_yn_req(&(lpprotocol_command->action_zigbee_mute), Alpcmd, "MUTE");
            p2p_nas_device_command_security_system_send_get_yn_resp(lpprotocol_command, &(lpprotocol_command->action_zigbee_mute), P2P_PROTOCOL_NAS_COMMAND_SECURITY_SYSTEM_GET_MUTE_RESP, Alphead);
        }
                                                                    break;
        case P2P_PROTOCOL_NAS_COMMAND_SECURITY_SYSTEM_SET_CALLOUT_REQ: {
            p2p_nas_device_command_security_system_recv_set_yn_req(&(lpprotocol_command->action_zigbee_callout), Alpcmd, "CALLOUT");
            p2p_nas_device_command_security_system_send_set_yn_resp(lpprotocol_command, &(lpprotocol_command->action_zigbee_callout), P2P_PROTOCOL_NAS_COMMAND_SECURITY_SYSTEM_SET_CALLOUT_RESP, Alphead);
        }
                                                                       break;
        case P2P_PROTOCOL_NAS_COMMAND_SECURITY_SYSTEM_GET_CALLOUT_REQ: {
            p2p_nas_device_command_security_system_recv_get_yn_req(&(lpprotocol_command->action_zigbee_callout), Alpcmd, "CALLOUT");
            p2p_nas_device_command_security_system_send_get_yn_resp(lpprotocol_command, &(lpprotocol_command->action_zigbee_callout), P2P_PROTOCOL_NAS_COMMAND_SECURITY_SYSTEM_GET_CALLOUT_RESP, Alphead);
        }
                                                                       break;
        default: {
...
void p2p_nas_device_command_security_system_init_action(p2p_nas_device_main_protocol_command_t *Alpprotocol_command) {
    {
