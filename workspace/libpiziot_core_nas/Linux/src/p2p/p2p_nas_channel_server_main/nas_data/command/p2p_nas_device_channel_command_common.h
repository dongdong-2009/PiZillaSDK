#ifndef __P2P_NAS_DEVICE_CHANNEL_COMMAND_COMMON_H__
#define __P2P_NAS_DEVICE_CHANNEL_COMMAND_COMMON_H__
...
extern "C"
{
    ...
    extern libpiziot_os_type_func_result_e p2p_nas_device_channel_command_common_parser(p2p_protocol_nas_command_e Acmd, int32_t Aarray_index, libpiziot_core_p2p_cmd_head_from_client_t *Alpcmd, libpiziot_core_p2p_data_from_client_head_t *Alphead);

    extern void p2p_nas_device_channel_command_common_send_action(int32_t Aarray_index);

    extern void p2p_nas_device_channel_command_common_init_action(p2p_nas_device_channel_main_protocol_command_t *Alpprotocol_command);
...
#endif //__P2P_NAS_DEVICE_CHANNEL_COMMAND_COMMON_H__
